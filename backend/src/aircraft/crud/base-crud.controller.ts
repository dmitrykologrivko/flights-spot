...
import { ValidationExceptionsFilter } from '@nestjs-boilerplate/core';
import { PermissionDeniedExceptionFilter } from '../permissions/permission-denied-exception.filter';
